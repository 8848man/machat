...
abstract class $ChatListModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ChatRoomData> roomList});
}
...
class _$ChatListModelImpl implements _ChatListModel {
  const _$ChatListModelImpl({final List<ChatRoomData> roomList = const []})
      : _roomList = roomList;
  ...
  @override
  String toString() {
    return 'ChatListModel(roomList: $roomList)';
  }
...
abstract class _ChatListModel implements ChatListModel {
  const factory _ChatListModel({final List<ChatRoomData> roomList}) =
      _$ChatListModelImpl;
