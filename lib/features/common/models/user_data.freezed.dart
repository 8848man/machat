...
class _$UserDataListImpl implements _UserDataList {
  const _$UserDataListImpl({required final List<UserData> userList})
      : _userList = userList;
  ...
  @override
  String toString() {
    return 'UserDataList(userList: $userList)';
  }
...
abstract class _UserDataList implements UserDataList {
  const factory _UserDataList({required final List<UserData> userList}) =
      _$UserDataListImpl;
