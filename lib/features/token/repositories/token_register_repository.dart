...
final tokenPackageRegisterProvider =
    Provider<TokenPackageRegisterService>((ref) {
  final firestore = FirebaseFirestore.instance;
  return TokenPackageRegisterRepository(firestore: firestore);
});

class TokenPackageRegisterRepository extends TokenPackageRegisterService {
  final FirebaseFirestore _firestore;

  static const String _tokenPackageCollection = 'token_packages';

  TokenPackageRegisterRepository({FirebaseFirestore? firestore})
